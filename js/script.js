...
**/
  ...
  $(function () {
	...
	**/
    ...
    $(".header").on("click", ".splitting-text-anim-2", function () {
...
**/
  ...
  function setHeightFullSection() {
    ...
    $(
      ".section.main-slider, .section.full-slider, .section.half-slider, .section.m-works-carousel, .section.m-contacts-map, .error-page, .section.hero-started, .menu-full-overlay, .preloader .centrize"
    ).css({ height: height });
    $(
      ".logged-in .section.main-slider, .logged-in .section.full-slider, .logged-in .section.half-slider, .logged-in .section.m-works-carousel, .logged-in .section.m-contacts-map, .logged-in .error-page, .logged-in .section.hero-started"
    ).css({ height: height - 32 });
    if (width < 783) {
      $(
        ".section.main-slider, .section.full-slider, .section.half-slider, .section.m-works-carousel, .section.m-contacts-map, .error-page, .section.hero-started, .menu-full-overlay, .preloader .centrize"
      ).css({ height: height });
